      ...
      <div className='flex items-center gap-6 w-4/5'>
        ...
        <div className='shadow flex py-3 px-2 w-3/4 border rounded'>
          <div className='flex gap-2 border-r-2 items-center px-2 w-1/3'>
            <i className='text-zomato-400 text-2xl'>
              <RoomIcon />
            </i>
            <input
              type='text'
      ...
      <div className='w-1/5 flex justify-end items-center'>
        {user?.fullName ? (
          ...
          <div className='flex gap-4 text-xl text-gray-500 cursor-pointer'>
            <span className='cursor-pointer' onClick={() => handleSignInOpen()}>
              Login
            </span>
            <span className='cursor-pointer' onClick={() => handleSignUpOpen()}>
              SignUp
            </span>
          </div>
        )}
    ...
    <>
      ...
      <div className='flex items-center justify-between shadow lg:hidden md:px-10 px-4 py-4'>
        ...
        <div className='flex items-center'>
          <div>
            <button className='bg-zomato-400 font-medium py-2 px-3 rounded-full text-white'>
              Use App
            </button>
          </div>
          {user.fullName ? (
