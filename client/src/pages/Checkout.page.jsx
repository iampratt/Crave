...
function Checkout() {
  ...
  return (
    <div className='flex justify-center overflow-hidden py-2 h-full w-full'>
      {cart && cart.length ? (
        <div className=' container mx-auto   px-3 md:flex  gap-4'>
          <div className='md:w-2/3 border shadow px-2 my-2'>
            <h1 className=' text-lg font-semibold  py-3 border-b-2'>
              Your Orders
            </h1>
          ...
          <div className='py-2 md:w-1/3 border shadow-md px-2 my-2 h-60 sticky top-0 z-10 bg-white'>
            <h2 className='text-lg font-semibold border-b-2 py-2'>
              Bill Summary
            </h2>
            ...
            <div className='py-3 flex items-center justify-center'>
              <button
                className='border px-3 py-2 rounded-full font-semibold bg-zomato-400 text-white'
                onClick={payNow}
              >
                {' '}
                <SecurityIcon /> Pay Securely
              </button>
            </div>
          </div>
        </div>
